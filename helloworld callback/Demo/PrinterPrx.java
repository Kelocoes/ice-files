...
{
    default void printString(String s, CallbackPrx callback)
    {
        printString(s, callback, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void printString(String s, CallbackPrx callback, java.util.Map<String, String> context)
    {
        _iceI_printStringAsync(s, callback, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> printStringAsync(String s, CallbackPrx callback)
    {
        return _iceI_printStringAsync(s, callback, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> printStringAsync(String s, CallbackPrx callback, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_printStringAsync(String iceP_s, CallbackPrx iceP_callback, java.util.Map<String, String> context, boolean sync)
    {
