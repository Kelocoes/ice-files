...
{
    default void getTask(String Function, double start, double end, int cantNum)
    {
        getTask(Function, start, end, cantNum, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void getTask(String Function, double start, double end, int cantNum, java.util.Map<String, String> context)
    {
        _iceI_getTaskAsync(Function, start, end, cantNum, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> getTaskAsync(String Function, double start, double end, int cantNum)
    {
        return _iceI_getTaskAsync(Function, start, end, cantNum, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> getTaskAsync(String Function, double start, double end, int cantNum, java.util.Map<String, String> context)
    {
        return _iceI_getTaskAsync(Function, start, end, cantNum, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_getTaskAsync(String iceP_Function, double iceP_start, double iceP_end, int iceP_cantNum, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(false, context, null, ostr -> {
                     ...
                     ostr.writeDouble(iceP_start);
                     ostr.writeDouble(iceP_end);
                     ostr.writeInt(iceP_cantNum);
                 }, null);
        return f;
    }

    default void connectionResponse(String msg)
    {
        connectionResponse(msg, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void connectionResponse(String msg, java.util.Map<String, String> context)
    {
        _iceI_connectionResponseAsync(msg, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> connectionResponseAsync(String msg)
    {
        return _iceI_connectionResponseAsync(msg, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> connectionResponseAsync(String msg, java.util.Map<String, String> context)
    {
        return _iceI_connectionResponseAsync(msg, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_connectionResponseAsync(String iceP_msg, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "connectionResponse", null, sync, null);
        f.invoke(false, context, null, ostr -> {
