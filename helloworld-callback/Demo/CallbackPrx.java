...
{
    default void callbackClient(Response res)
    {
        callbackClient(res, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void callbackClient(Response res, java.util.Map<String, String> context)
    {
        _iceI_callbackClientAsync(res, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> callbackClientAsync(Response res)
    {
        return _iceI_callbackClientAsync(res, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> callbackClientAsync(Response res, java.util.Map<String, String> context)
    {
        return _iceI_callbackClientAsync(res, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_callbackClientAsync(Response iceP_res, java.util.Map<String, String> context, boolean sync)
    {
